...
[2. MonoBehaviour](#MonoBehaviour)
 - [2.1 스크립트 직렬화 기능](#1.-스크립트-직렬화-기능)
 - [2.2 유니티 메시지 이벤트 기능](#2.-유니티-메시지-이벤트-기능)

## 기본 구조

유니티는 컴포넌트 구조 기반으로 만들어진 게임 엔진이다.
...
>Update() 함수처럼 모든 오브젝트에 Update() 실행하라고 메시지를 날림 / update가 없으면 반응안함
...
#### 3. 코루틴 기능
	- 서브 루틴을 일시 정지하고 재개할 수 있는 구성 요소를 말한다. 쉽게 말해 필요에 따라 일시 정지할 수 있는 기능을 말한다.
